...
- Read `skills/filtercapital-skills/SKILL.md` before evaluating candidates. Reconstruct the candidate story before applying judgment lenses; if the target audience is ambiguous, request confirmation and do not issue a final decision.
