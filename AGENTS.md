...
- Read `skills/resume-screening/SKILL.md` before evaluating candidates. Select the intern or new-graduate logic from the recruitment target; if ambiguous, request confirmation and do not issue a final decision.
