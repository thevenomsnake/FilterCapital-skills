...
Once the fast-start gate has failed, do not use trajectory to repeat that rejection. When the gate passes, use this section for path progression and transition credibility rather than re-counting the same workflow-transfer evidence.
