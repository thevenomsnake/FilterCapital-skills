...
Assume structured training, rotation, and long trial periods are limited. Evaluate whether the candidate can contribute quickly with modest guidance and has credible reasons to remain.
...
- a course, training, or production-style project whose origin and data access are unclear;
...
- if credentials, access, team results, or project packaging mask weak personal execution, the candidate may require too much verification and onboarding.
...
Return: `score 0-5`, risk branches, counterevidence, branch convergence, and confidence.
