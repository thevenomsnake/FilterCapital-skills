...
The recurring work usually connects:

1. a game or product question to measurable events, cohorts, segments, or operational outcomes;
2. accessible event or business inputs to usable, documented tables or extracts;
3. cleaning, transformation, labels, metric definitions, and denominator choices;
4. recurring reports, dashboards, monitoring, or decision support;
5. anomaly diagnosis, quality checks, validation, and follow-up decisions.

Adapt this sequence to the actual JD. Do not require monetization, retention, experimentation, or any other stage that the role does not use.
...
- Keep the module vector separate; these priority tiers do not create an uncalibrated numeric total.
- Do not apply this profile to marketing, sales, business development, general operations, or unrelated analyst roles.
- Do not use school, geography, politics, protected attributes, or a single wording error as capability evidence.
- Do not persist candidate names, raw resumes, private artifacts, credentials, or screenshots.
